...
void (*ptrINT0_ISR) (void) = NULL;
void (*ptrINT1_ISR) (void) = NULL;
void (*ptrINT2_ISR) (void) = NULL;
...
void MEXTI_voidInt1Initialize(u8 copy_u8Method)
{
	...
	switch(copy_u8Method)
	{
		...
		MDIO_u8SetPinValue(PORTD,PIN3,PIN_HIGH);
		break;
		
		case RISING_EDGE:
		SET_BIT(MCUCR,MCUCR_ISC11);
		SET_BIT(MCUCR,MCUCR_ISC10);
		MDIO_u8SetPinValue(PORTD,PIN3,PIN_LOW);
		break;
